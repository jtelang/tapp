...
public class SongListAdapterOld extends BaseAdapter {

	private Activity activity = null;
	private ArrayList<SongData> list = null;
	private LayoutInflater mInflater = null;

	public SongListAdapterOld(Activity activity, ArrayList<SongData> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder mHolder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.row_song_list_old, parent, false);
